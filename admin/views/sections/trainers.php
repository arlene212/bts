...
<section class="main-content tab-content" id="trainers">
  ...
  <div class="tab-inner active" id="activeTrainers" data-tab-content>
    ...
    <div class="table-container">
      <table class="table table-striped table-hover trainer-table"><thead><tr><th>User ID</th><th>User Name</th><th>Email</th><th>Contact Number</th><th>Assigned Courses</th><th>Date Created</th><th>Actions</th></tr></thead><tbody>
          ...
          <?php foreach ($activeTrainers as $trainer): ?>
            <tr>
              ...
              <td class="table-actions">
                <button class="action-btn edit edit-trainer-btn btn btn-sm btn-outline-primary" title="Edit" data-user-id="<?php echo $trainer['user_id']; ?>" data-user-data='<?php echo htmlspecialchars(json_encode($trainer), ENT_QUOTES, 'UTF-8'); ?>'><i class="fas fa-edit"></i><span class="btn-text">Edit</span></button>
