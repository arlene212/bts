...
<body>
    <div class="container">
        ...
        <aside class="sidebar">
            <div class="profile">
                <div class="user-card">
                    <div class="user-card-header">
                        <img src="<?php echo !empty($user['profile_picture']) ? '../uploads/profiles/' . htmlspecialchars($user['profile_picture']) : '../images/school.png'; ?>"
            ...
            <nav class="nav">
                <a href="#" class="tab-link <?php echo $currentTab === 'home' ? 'active' : ''; ?>"
                    data-tab="home">Home</a>
                <a href="#" class="tab-link <?php echo $currentTab === 'courses' ? 'active' : ''; ?>"
                    data-tab="courses">Offered Courses</a>
                <a href="#" class="tab-link <?php echo $currentTab === 'enrolled' ? 'active' : ''; ?>"
                    data-tab="enrolled">Enrolled Courses</a>
                <a href="#" class="tab-link <?php echo $currentTab === 'aboutUs' ? 'active' : ''; ?>"
                    data-tab="aboutUs">About US</a>
            </nav>
        </aside>
        ...
        <main class="main">
            ...
            <div class="content">
                <div class="main-section">
                    <!-- ===== HOME TAB ===== -->
                    <section class="main-content tab-content <?php echo $currentTab === 'home' ? 'active' : ''; ?>"
                        id="home">
                        <div class="dashboard tab-inner active" id="dashboard">
                            <div class="slogan-box">
                                <div class="slogan-text">
                                    <div class="welcome-header">
                                        ...
                                        <div>
                                            ...
                                            <p><strong>Enrolled Courses:</strong>
                                                <?php echo count($enrolled_courses); ?> | <strong>Pending
                                                    Requests:</strong>
                                                <?php echo count(array_filter($enrollment_requests, function ($r) {
                                ...
                                <div class="slideshow-container">
                                    <div class="slider">
                                        <div class="slide active" style="background-image: url('../images/bts3.jpg');">
                                        </div>
                    ...
                    <!-- ===== OFFERED COURSES TAB ===== -->
                    <section class="main-content tab-content <?php echo $currentTab === 'courses' ? 'active' : ''; ?>"
                        id="courses">
                        ...
                        <div id="courseGrid" class="dashboard-cards">
                            <?php if (!empty($offered_courses)): ?>
                                <?php foreach ($offered_courses as $course): ?>
                                    ...
                                    ?>
                                    <div class="dashboard-card course-card card" style="width: 18rem; height: 20rem;"
                                        ...
                                        <img src="<?php echo !empty($course['image']) ? '../uploads/courses/' . htmlspecialchars($course['image']) : '../images/course-placeholder.jpg'; ?>"
                                            alt="<?php echo htmlspecialchars($course['course_name']); ?>" class="course-img">
                                        <div class="label-text"><?php echo htmlspecialchars($course['course_name']); ?></div>
                                        <div class="sub-text"><?php echo htmlspecialchars($course['course_code']); ?> |
                    ...
                    <section class="main-content tab-content <?php echo $currentTab === 'enrolled' ? 'active' : ''; ?>"
                        id="enrolled">
                        <button id="backToEnrolledCourses" class="back-btn hidden" aria-label="Back">
                            <i class="fa-solid fa-arrow-left"></i>
                        </button>
                        <h2>Enrolled Courses</h2>
                        <div id="enrolledCoursesContainer" class="dashboard-cards card"
                        ...
                        <div id="courseDetail" class="course-detail hidden">
                            <div class="course-detail-header">
                                <button id="unenrollCourseBtn" class="unenroll-btn"
                                    title="Unenroll from this course">Unenroll</button>
                            </div>
                    ...
                    <!-- ===== ABOUT US TAB ===== -->
                    <section class="main-content tab-content <?php echo $currentTab === 'aboutUs' ? 'active' : ''; ?>"
                        id="aboutUs">
                        <h2>About Benguet Technical School</h2>
                        <div class="about-content">
                            <p>
                                BENGUET TECHNICAL SCHOOL IS AN LGU-RUN TECHNICAL VOCATIONAL INSTITUTION UNDER THE
                                PROVINCIAL GOVERNMENT OF BENGUET.
                                IT OFFERS VARIOUS PROGRAMS/SHORT COURSES ACCREDITED BY TESDA.
                            </p>
                            <p>
                                The Benguet Technical School traces its roots back to 1997, when then-President Fidel V.
                                Ramos allocated ₱75 million from his Presidential Social Fund to establish Livelihood
                                Training and Productivity Centers in marginalized regions across the country, including
                                the Cordillera Administrative Region.
                            </p>
                            <p>
                                Today, Benguet Technical School stands as a lasting legacy of collaboration between the
                                national government, the provincial government, and private partners. From its
                                beginnings as a livelihood training center to its present role, BTS remains committed to
                                providing opportunities that uplift the socio-economic conditions of communities in
                                Benguet and the greater Cordillera region.
                            </p>
        ...
        <div class="modal-content">
            ...
            <form class="modal-form" id="profileForm">
                ...
                <div>
                    ...
                    <input type="text" id="contactNumber" name="contact_number" placeholder="Enter Contact Number"
                        value="<?php echo htmlspecialchars($user['contact_number'] ?? ''); ?>">
                    <div class="validation-error hidden" id="contactError">Please enter a valid contact number</div>
                </div>
    ...
    <div id="unenrollConfirmModal" class="modal hidden">
        <div class="modal-content small-modal">
            ...
            <p>Are you sure you want to unenroll from <strong id="unenrollConfirmCourseName"></strong>? Your progress in
                this course will be lost.</p>
            <div class="modal-actions">
